...
var _ = require('lodash'),
  ...
  Entries = require('../classes/entries'),
  mfTools = require('../utils/mf-tools'),
  ...
  entryCollection = new Entries({
    knex: knex,
    requestBroker: requestBroker,
    mentionsCacheLimit: options.mentionsCacheLimit
  }),
  metaDataFetcher = new MetaDataFetcher(entryCollection),
...
module.exports = function (app) {
  ...
  return {
    close: function () {
      pubsub.close();
      // TODO: Update the shutdown to work post-refactor
      broker.close();
