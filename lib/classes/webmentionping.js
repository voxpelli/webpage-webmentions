...
WebMentionPing.prototype.saveMention = function (mention) {
  ...
  return updateMention()
    .bind(this)
    .then(function (id) {
      return id.length ? id[0] : knex.table('entries').insert(mention, 'id');
    })
    .catch(function (err) {
    ...
    .catch(function (err) {
      ...
      if (err.code === '23505') {
        ...
        //TODO: Update interaction-status of all mentions and removed mentions that no longer exist
